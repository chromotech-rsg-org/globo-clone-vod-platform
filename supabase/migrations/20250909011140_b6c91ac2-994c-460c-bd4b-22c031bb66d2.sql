...
-- Create unique constraint to prevent duplicate bids on same lot
ALTER TABLE public.bids 
ADD CONSTRAINT unique_bid_per_lot_value 
UNIQUE (auction_item_id, bid_value);

-- Update validate_bid_value function to use lot-specific increment
...
-- Create function to auto-approve bids and update lot value
