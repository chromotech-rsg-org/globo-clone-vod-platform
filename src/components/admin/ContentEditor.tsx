...
const ContentEditor = () => {
  ...
  const ItemEditor = ({ item, sectionId }: { item?: ContentItem; sectionId: string }) => {
            ...
            {formData.image_url && (
              <div className="mb-2">
                <img 
                  ...
                  alt="Preview" 
                  className="w-20 h-28 object-cover rounded border border-admin-border"
                />
              </div>
            )}
            <ImageUpload
  ...
  if (loading) {
    return (
      <div className="text-admin-foreground">Carregando conteúdo...</div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          onClick={() => setEditingSection({} as ContentSection)}
          variant="admin"
          size="sm"
        >
          ...
          <TabsContent key={section.id} value={section.id} className="space-y-4">
            <Card className="bg-admin-card border-admin-border">
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-admin-foreground">{section.title}</CardTitle>
                ...
                <div className="flex space-x-2">
                  ...
                  <Button
                    onClick={() => setEditingItem({} as ContentItem)}
                    variant="admin"
                    size="sm"
                  >
                    <Plus className="h-4 w-4 mr-2" />
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {section.content_items?.map((item) => (
                    <Card key={item.id} className="bg-admin-muted border-admin-border">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex space-x-2">
                              <Button
                                ...
                                variant="outline"
                                size="sm"
                                className="flex-1 border-admin-border text-admin-foreground"
                              >
