...
const PendingNotificationItem: React.FC<PendingNotificationItemProps> = ({
  ...
  return <Card className="p-3 cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => onClick(item)}>
      <CardContent className="p-0">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            {item.type === 'bid' ? <p className="font-semibold text-slate-50">
