  ...
  const validateCoupon = async () => {
    ...
    try {
      const {
        data,
        error
      } = await supabase.from('coupons').select('*').eq('code', couponCode.toUpperCase()).eq('active', true).maybeSingle();
      ...
      <Card className="bg-gray-700 border-gray-600">
        <CardContent className="p-6">
          <div className="space-y-4">
            ...
            {validatedCoupon && <div className="p-4 bg-green-900/20 border border-green-500/30 rounded-lg">
                ...
                <div className="text-white">
                  ...
                  {validatedCoupon.notes && <p className="text-sm text-gray-400 mt-1">
