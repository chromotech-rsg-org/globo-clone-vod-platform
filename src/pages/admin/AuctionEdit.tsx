  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const auctionData = {
        ...
        start_date: auction.start_date ? new Date(auction.start_date as string).toISOString() : null,
        end_date: auction.end_date ? new Date(auction.end_date as string).toISOString() : null,
