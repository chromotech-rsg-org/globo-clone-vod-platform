      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {user?.role === 'user' && user?.subscription && (
          <Card className="bg-gray-800 border-gray-700 mb-8">
            <CardHeader>
              <CardTitle className="text-white">Minha Assinatura</CardTitle>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-400">Renova em</p>
                  <p className="text-white font-semibold">{user.subscription.expiresAt}</p>
                </div>
              </div>
            </CardContent>
          </Card>
